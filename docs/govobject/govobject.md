...
# Governance Object
A Governance Object (or "govObject") is a generic structure introduced in Artax Core v12.1 to allow for the creation of Budget Proposals, Triggers, and Watch Dogs. Class inheritance has been utilized to extend this generic object into a "Proposal" which is outlined throughout the remainder of this document. 
...
var jsonProposal = {
  ...
  url:"http://www.artax.org/proposal/first_proposal"
};
...
```javascript
proposal.url="http://artax.org/badUrl"
var shallowCopyProposal = proposal.shallowCopy();
proposal.url="http://artax.org/fixedUrl"
